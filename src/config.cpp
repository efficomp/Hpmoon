 ...
 * @date 14/02/2016
 * @brief Implementation necessary to extract the program configuration parameters from command-line or an XML configuration file. Internal parameters are also considered
...
Config::Config(const int argc, const char **argv) {
	...
	CmdParser parser("DESCRIPTION: Hpmoon is a parallel and distributed multi-objective genetic algorithm to EEG classification", "mpirun [MPI OPTIONS] ./bin/hpmoon [ARGS]", "Hpmoon (c) 2015 EFFICOMP");
